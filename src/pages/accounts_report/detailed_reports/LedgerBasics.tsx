...
// import { Division, openChequeMonitoringReport } from "../../../api/transactions";
...
//                                 // 2. Call the function to open the report tab
//                                 // Note: We remove code20: "RAWSQL" so the backend generates the HTML instead of returning SQL
//                                 await openChequeMonitoringReport({
...
export default function FinanceReportFilter() {
    ...
    const handleGenerate = async () => {
        ...
        if (options.chequeDateWise) {
            try {
                await openChequeMonitoringReport({ ...params, code20: "DATE_WISE" });
            } catch (err: any) {
