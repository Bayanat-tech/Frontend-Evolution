...
//           u.default_div === "Y" || u.default_div === true || u.default_div === "1"
//         );
//         return (
//           <input
//             type="checkbox"
...
//                 : undefined
//             }
//             onClick={(e) => isPending && e.stopPropagation()}
//             className={`h-4 w-4 accent-primary ${isPending ? "cursor-pointer" : "cursor-default"}`}
//           />
//         );
//       },
//     },
...
//     if (!divCode || pendingUsers.length === 0) return;
//     setIsSaving(true);
//     try {
...
//       await api.post("/api/finance/upsertSecDivUser", [
//         ...savedPayload,
//         ...pendingPayload,
//       ]);
...
//             <Button
//               onClick={handleSave}
//               disabled={!divCode || pendingUsers.length === 0 || isSaving}
//             >
