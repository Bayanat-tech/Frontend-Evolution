      ...
      >
        ...
        <div className="prf-wrap">
          ...
          <table className="prf-tbl prf-sec5">
            <tbody>
              <tr>
                <td colSpan={4} className="c-bold c-section-head">
                  Section 5 : Comments &amp; Signatures:
                </td>
              </tr>
              <tr>
                <td colSpan={4} className="c-instruction">
              ...
              {/* Headers */}
              <tr>
                <td className="c-dark-header" style={{ width: "25%" }}>Approved By</td>
                <td className="c-dark-header" style={{ width: "25%" }}>Appraiser Comments</td>
                <td className="c-dark-header" style={{ width: "25%" }}>Appraisee Comments</td>
                <td className="c-dark-header" style={{ width: "25%" }}>Appraisee Signature &amp; Date</td>
              </tr>

              {/* Data Rows — level-wise */}
              {flowHistory.length === 0 ? (
                <tr>
                  <td style={{ padding: "5px 6px", height: "40px" }}>&nbsp;</td>
                  <td style={{ padding: "5px 6px", height: "40px" }}>
                    {section5.APPRAISER_COMMENTS
                      ? <span className="c-comment-text">{section5.APPRAISER_COMMENTS}</span>
                      : <span>&nbsp;</span>}
                  </td>
                  <td style={{ padding: "5px 6px", height: "40px" }}>
                    {section5.APPRAISEE_COMMENTS
                      ? <span className="c-comment-text">{section5.APPRAISEE_COMMENTS}</span>
                      : <span>&nbsp;</span>}
                  </td>
                  <td style={{ padding: "5px 6px", height: "40px" }}>
                    <div style={{ borderBottom: "1px solid #000", height: "20px", marginBottom: "4px" }} />
                  </td>
                </tr>
              ) : (
                flowHistory.map((f: AppraisalFlowHistory, idx: number) => {
                  ...
                  const comment =
                    level >= 1 && level <= 5 ? commentsByLevel[level - 1] : "";
