...
//   const handleReport = async (report_id: string, stn_no: string, company_code: string, prin_code: string) => {
//     console.log("handleReport called with:", { report_id, stn_no, company_code, prin_code });
//     const route : { [key: string]: string } = {
//       "1" : '/api/wms/reports/stockconfirmation-report/html?stn_no=' + stn_no + '&company_code=' + company_code + '&principal_code=' + prin_code,
//       "2" : '/api/wms/reports/stockconfirmation-report/html?&stn_no=' + stn_no + '&company_code=' + company_code + '&principal_code=' + prin_code,
//     }
//     const reportHtml = await api.get(route[report_id], { responseType: "text" });
//     console.log("Report HTML fetched:", reportHtml);
//     return
//   }

//   const handleExcel = async (report_id: string, stn_no: string, company_code: string, prin_code: string) => {
//     console.log("handleExcel called with:", { report_id, stn_no, company_code, prin_code });
//     const route : { [key: string]: string } = {
//       "1" : '/api/wms/reports/stockconfirmation-report/excel?stn_no=' + stn_no + '&company_code=' + company_code + '&principal_code=' + prin_code,
//       "2" : '/api/wms/reports/stockconfirmation-report/excel?&stn_no=' + stn_no + '&company_code=' + company_code + '&principal_code=' + prin_code,
//     }
//     const reportExcel = await api.get(route[report_id], { responseType: "blob" });
//   }
...
//             <p className="m-0 text-[11px] font-bold uppercase tracking-widest text-muted-foreground">Stock Transfer hello world</p>
