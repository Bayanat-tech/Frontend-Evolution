    ...
    return (
        <div className="rounded-md border bg-card">
            ...
            <CompactSection label="Document & Party">
                ...
                <CField label="PO NO *">
                    <Input type="text" disabled={headerAndLineDisabled} required value={form.po_doc_no} onChange={(event) => updateField("po_doc_no", event.target.value)} />
                </CField>
                ...
                <CField label="Quotn No">
                    <Input className="text-right" type="number" disabled={headerAndLineDisabled} value={form.po_ref_no} onChange={(event) => updateField("po_ref_no", event.target.value)} />
                </CField>
                <CField label="Quotn Date">
                    <Input type="date" disabled={headerAndLineDisabled} value={form.po_ref_date} onChange={(event) => updateField("po_ref_date", event.target.value)} />
                </CField> */}
                ...
                <CField label="Tel">
                    <Input className="text-right" type="number" disabled={headerAndLineDisabled} value={form.po_party_phone} onChange={(event) => updateField("po_party_phone", event.target.value)} />
                </CField>
            ...
            <CompactSection label="Order, Currency & Tax">
                ...
                <CField label="Remarks" className="col-span-2">
                    <Input
                        ...
                        onChange={(event) =>
                            updateField("po_remarks", event.target.value)
                        }
                    />
                </CField>
            ...
            >
                <CField label="Project Name" className="col-span-2">
                    <Input
                        disabled={headerAndLineDisabled}
                        value={form.po_project_name}
                        onChange={(event) =>
                            updateField("po_project_name", event.target.value)
                        }
                    />
                </CField>
                ...
                <CField label="PR No">
                    <Input
                        ...
                        value={form.po_pr_no}
                        onChange={(event) =>
                            updateField("po_pr_no", event.target.value)
                        }
                    />
                </CField>
                ...
                <CField label="Scope of Work" className="col-span-2">
                    <Input
                        disabled={headerAndLineDisabled}
                        value={form.po_scope_of_work}
                        onChange={(event) =>
                            updateField("po_scope_of_work", event.target.value)
                        }
                    />
                </CField>
