...
//                   value="PO"
//                   checked={form.discount_scoope === "PO"}
//                   disabled={headerAndLineDisabled}
//                   onChange={() =>
//                     setForm((current) => ({
//                       ...current,
...
//                   value="ITEM"
//                  checked={(form.discount_scoope || "ITEM") === "ITEM"}
//                   disabled={headerAndLineDisabled}
//                   onChange={() =>
//                     setForm((current) => ({
//                       ...current,
...
//                 }
//                 onChange={(e) =>
//                   updateField("disc_hdr_price", Number(e.target.value || 0))
//                 }
//               />
//             </CField>
//             <CField label="Disc %">
...
//                     step="0.01"
//                     disabled={headerAndLineDisabled}
//                     value={numberOrZero(form.disc_hdr_price)}
//                     onChange={(e) =>
//                       updateField(
//                         "disc_hdr_price",
//                         Number(e.target.value || 0)
...
//                     step="0.01"
//                     disabled={headerAndLineDisabled}
//                     value={numberOrZero(form.disc_hdr_percent)}
//                     onChange={(e) =>
//                       updateField(
//                         "disc_hdr_percent",
//                         Number(e.target.value || 0)
...
export function PurchaseOrderHeaderForm({
  ...
  const loginIdOrAdmin = loginid || "ADMIN";
  // Single source of truth for the discount scope default. The radio's
  // "checked" state and the Disc Amt/% calc logic must use the SAME
  // fallback, or the UI shows "Individual Items" selected on load while
  // the calc logic silently behaves as "PO" until the user clicks a radio.
