...
function AlertGrid({ rows, setRows, deleteRow }: GridProps) {
  return <EditableGrid columns={["op_code", "op_desc", "op_date", "op_yesno", "op_count", "remarks"]} rows={rows} setRows={setRows} deleteRow={deleteRow} addFactory={() => ({ OP_CODE: "", OP_DESC: "", OP_DATE: "", OP_YESNO: "", OP_COUNT: "0", REMARKS: "" })} />;
}
